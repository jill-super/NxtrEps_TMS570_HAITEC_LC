...
extern VAR(uint8, NVM_APPL_DATA) Rte_BatteryVoltage_OvervoltageData[];
...
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_SupplierIdentifierData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_SparePartNumberData[];
...
#include "MemMap.h"
    ...
    /* block descriptor user block Deprecated_NVM_BLOCK_DEM */
    ,{
    ...
    ,{
        (NvM_RamAddressType)&Rte_BatteryVoltage_OvervoltageData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_SupplierIdentifierData */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_SupplierIdentifierData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_SparePartNumberData */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_SparePartNumberData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        ...
        315u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
        NVM_BLOCK_NATIVE,/* Management Type */
