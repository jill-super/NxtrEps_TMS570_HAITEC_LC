...
#  define Rte_IWrite_DigMSB_Per2_CumMechMtrPosCRF_Deg_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Sa_DigMSB_DigMSB_Per2.Rte_CumMechMtrPosCRF_Deg_f32.value = (data) \
  )

#  define Rte_IWriteRef_DigMSB_Per2_CumMechMtrPosCRF_Deg_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Sa_DigMSB_DigMSB_Per2.Rte_CumMechMtrPosCRF_Deg_f32.value)
