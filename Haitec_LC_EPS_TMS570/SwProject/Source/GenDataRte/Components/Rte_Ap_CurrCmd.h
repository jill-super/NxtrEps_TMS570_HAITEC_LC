...
#  define Rte_IRead_CurrCmd_Per1_EstKe_VpRadpS_f32() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_EstKe_VpRadpS_f32.value)
...
#  define Rte_IWrite_CurrCmd_Per1_MtrCurrDaxRef_Amp_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_MtrCurrDaxRef_Amp_f32.value = (data) \
  )

#  define Rte_IWriteRef_CurrCmd_Per1_MtrCurrDaxRef_Amp_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_MtrCurrDaxRef_Amp_f32.value)

#  define Rte_IWrite_CurrCmd_Per1_MtrCurrQaxRef_Amp_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_MtrCurrQaxRef_Amp_f32.value = (data) \
  )

#  define Rte_IWriteRef_CurrCmd_Per1_MtrCurrQaxRef_Amp_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_MtrCurrQaxRef_Amp_f32.value)
