...
;       to suppress warning "no matching section"
   .sect ".ossDataTask_SchM_2ms_9:noinit"
   .sect ".ossDataTask_SchM_2ms_9:init"
...
; END OF C:\SynergyProjects\Haitec_LC_EPS_TMS570-nzx5jd\Haitec_LC_EPS_TMS570\Tools\AsrProject\..\..\SwProject\Source\GenData\\..\GenDataOS\intvect.asm
