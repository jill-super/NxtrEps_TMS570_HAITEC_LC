...
/**********************************************************************************************************************
  VERSION CHECK
**********************************************************************************************************************/
# define GW_ASRPDUR_CANTP_VERSION            (0x0315u)
# define GW_ASRPDUR_CANTP_RELEASE_VERSION            (0x10u)
...
**********************************************************************************************************************/
/** \brief    The function is called by the CanTp to receive a CanTp SDU.
...
**********************************************************************************************************************/
FUNC(BufReq_ReturnType, PDUR_CODE) PduR_CanTpProvideRxBuffer(PduIdType CanTpRxPduId, PduLengthType TpSduLength,
                                                             P2VAR(PduInfoTypeApplPtr, AUTOMATIC,
                                                                   PDUR_APPL_DATA) PduInfoPtr);
/**********************************************************************************************************************
  PduR_CanTpRxIndication
**********************************************************************************************************************/
/** \brief    The function is called by the CanTp to indicate the complete receiption of a CanTp SDU
...
**********************************************************************************************************************/
/** \brief    The function is called by the CanTp to request a CanTp TX SDU before transmission. The called module
...
**********************************************************************************************************************/
/** \brief    The function is called by the CanTp to confirm a successful transmission of a CanTp TX SDU
...
#  if (PDUR_CANTPCHANGEPARAMETER_SUPPORT == STD_ON)
/**********************************************************************************************************************
  PduR_CanTpChangeParameterConfirmation
**********************************************************************************************************************/
/** \brief    The function is called by the CanTp to confirm a successful parameter change 
              or to report an error that occurred during transmission.
              The PDU Router evaluates the CanTp I-PDU handle and performs appropriate handle and port conversion.
              The call is routed to an upper TP module using the appropriate I-PDU handle of the destination layer.
    \param    CanTpRxPduId                      ID of the CanTp I-PDU that parameter has been changed.
