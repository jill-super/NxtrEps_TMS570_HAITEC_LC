...
/**********************************************************************************************************************
  VERSION CHECK
**********************************************************************************************************************/
# define GW_ASRPDUR_CANIF_VERSION            (0x0315u)
# define GW_ASRPDUR_CANIF_RELEASE_VERSION            (0x10u)
...
/** \brief         The function is called by the CanIf to indicate the complete reception of a CanIf I-PDU.
    ...
    \param[in]     CanIfRxPduId        Handle ID of the received CanIf I-PDU.
...
**********************************************************************************************************************/
/** \brief         The function is called by the CanIf to indicate the complete transmission of a CanIf I-PDU.
                   The PDU Router evaluates the CanIf I-PDU handle and performs appropriate handle and port conversion.
                   The call is routed to an upper IF module using the appropriate I-PDU handle of the destination layer.
    \param[in]     CanIfTxPduId        Handle ID of the transmitted CanIf I-PDU.
    \return        none
    \pre           PduR_Init() is executed sucessfully and the PDU Router is in PDUR_ONLINE state.
    \context       The function can be called on interrupt and task level and has not to be interrupted by other
