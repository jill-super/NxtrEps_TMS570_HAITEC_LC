...
/**********************************************************************************************************************
  VERSION CHECK
**********************************************************************************************************************/
# define GW_ASRPDUR_CANNM_VERSION            (0x0315u)
# define GW_ASRPDUR_CANNM_RELEASE_VERSION            (0x10u)
...
/** \brief         The function is called by the CanNm to indicate the complete reception of a CanNm I-PDU.
                   The PDU Router evaluates the CanNm I-PDU handle and performs appropriate handle and port conversion.
                   The call is routed to an upper IF module using the appropriate I-PDU handle of the destination layer.
    \param[in]     CanNmRxPduId        Handle ID of the received CanNm I-PDU.
...
**********************************************************************************************************************/
/** \brief         The function is called by the CanNm to indicate the complete transmission of a CanNm I-PDU.
                   The PDU Router evaluates the CanNm I-PDU handle and performs appropriate handle and port conversion.
                   The call is routed to an upper IF module using the appropriate I-PDU handle of the destination layer.
    \param[in]     CanNmTxPduId        Handle ID of the transmitted CanNm I-PDU.
    \return        none
    \pre           PduR_Init() is executed sucessfully and the PDU Router is in PDUR_ONLINE state.
    \context       The function can be called on interrupt and task level and has not to be interrupted by other
...
**********************************************************************************************************************/
/** \brief         The function is called by the CanNm to request the CanNm TX I-PDU data before transmission.
                   The PDU Router evaluates the CanNm I-PDU handle and performs appropriate handle and port conversion.
                   The call is routed to an upper IF module using the appropriate I-PDU handle of the destination layer.
    \param[in]     CanNmTxPduId        Handle ID of the CanNm I-PDU that will be transmitted.
    \param[in,out] PDUR_TRIGGERTRANSMIT_PARA
                   SduPtr         Pointer to the I-PDU data buffer of the CanNm IF that will be transmitted.\n
                                     This Parameter is used, if PDUR_USE_PDUINFOTYPE is defined to STD_OFF.\n
                   PduInfoPtr        Payload information of the CanNm I-PDU that will be transmitted (pointer to data and data length).\n
                                     This Parameter is used, if PDUR_USE_PDUINFOTYPE is defined to STD_ON.\n
