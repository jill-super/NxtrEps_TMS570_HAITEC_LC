...
# 2008/07/01   1.01     Get   Added library support                        #
#-----------------------------------------------------------------------------#
...
LIBRARIES_TO_BUILD      += Vmm
Vmm_FILES                = Vmm\Vmm.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Vmm\Vmm.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Vmm_Lcfg.c
