...
# 2008/02/13   1.01     Jk   Support of AUTOSAR CanSm                         #
# 2008/04/30   1.02     fbg  Changes for ASR library support                  #
# 2008/10/07   1.03     MFi  correct BSW short name ESCAN00030259							#
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\CanSM_Lcfg.c $(GENDATA_DIR)\CanSM_PBcfg.c
