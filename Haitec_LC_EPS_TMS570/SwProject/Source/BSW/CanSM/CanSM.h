...
# define CCL_ASRSMCAN_VERSION                                         0x0116u   /* BCD coded version number */
# define CCL_ASRSMCAN_RELEASE_VERSION                                 0x03u   /* BCD coded release version number  */
...
# define CANSM_PREVENTBUSSLEEPATSTARTUP_SERVICE_ID                    (0x06u)
...
typedef struct
{
  CanSM_BorTimerType              CanSm_BorTimer;
