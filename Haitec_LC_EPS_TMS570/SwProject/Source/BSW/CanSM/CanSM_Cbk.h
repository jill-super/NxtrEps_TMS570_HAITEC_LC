...
# include "Std_Types.h"         /* needed cause of uint8 */
...
# define CCL_ASRSMCAN_CALLBACK_HEADER_VERSION                         0x0116u   /* BCD coded version number */
# define CCL_ASRSMCAN_CALLBACK_HEADER_RELEASE_VERSION                 0x03
