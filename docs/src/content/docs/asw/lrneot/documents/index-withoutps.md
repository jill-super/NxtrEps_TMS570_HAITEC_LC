...
> **Source document:** `LrnEOT/utp/Tessy/report/index_WithOutPS.pdf`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: PDF document (115 pages).

**Pages:** 115 **Report tool:** TESSY

---

## Test report summary

This is an automatically generated unit-test report with **115 pages**. Only the summary is reproduced here; the full step-by-step report remains in the repository.

| Item | Value |
| --- | --- |
| Detail | Test Object "CBD_UnitTest/LrnEOT/LrnEOT_Init1" |
...
No. Name C0 C1 DC MC/DC MCC Test Cases Result
 LrnEOT 100 % 100 % 100 % 100 % 100 % 10 of 10 passed
 CBD_UnitTest 100 % 100 % 100 % 100 % 100 % 10 of 10 passed
 LrnEOT 100 % 100 % 100 % 100 % 100 % 10 of 10 passed
1 LrnEOT_Init1 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
2 LrnEOT_Per1 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
3 LrnEOT_Scom_ResetEOT 100 % 100 % - - - 1 of 1 passed
4 ResetEOT 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
```
