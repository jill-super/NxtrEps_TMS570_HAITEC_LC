...
> **Source document:** `EtDmpFw/utp/Tessy/report/index_WithOutPS_FLTINJ.pdf`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: PDF document (81 pages).

**Pages:** 81 **Report tool:** TESSY

---

## Test report summary

This is an automatically generated unit-test report with **81 pages**. Only the summary is reproduced here; the full step-by-step report remains in the repository.

| Item | Value |
| --- | --- |
| Detail | Test Object "CBD_UnitTest/EtDmpFw_FLTINJ/EtDmpFw_Per1" |
...
No. Name C0 C1 DC MC/DC MCC Test Cases Result
 EtDmpFw 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
 CBD_UnitTest 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
 EtDmpFw_FLTINJ 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
1 EtDmpFw_Per1 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
```
