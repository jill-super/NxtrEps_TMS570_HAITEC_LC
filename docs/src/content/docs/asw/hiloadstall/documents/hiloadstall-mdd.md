---
title: "HiLoadStall Module Design Document"
description: "Converted from HiLoadStall_MDD.docx"
---

> **Source document:** `HiLoadStall/doc/HiLoadStall_MDD.docx`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: Word document (`.docx`, 126 paragraphs, 12 tables, 1 embedded figures).

**Author:** User **Last saved by:** Smith, Kevin **Revision:** 55
...
![Embedded figure](hiloadstall-mdd-fig1.png)
