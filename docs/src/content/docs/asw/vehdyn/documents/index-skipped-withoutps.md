---
title: "Unit-Test Report ((skipped cases) without Power Steering)"
description: "Tessy unit-test report summary"
---

> **Source document:** `VehDyn/utp/Tessy/report/index_Skipped_WithoutPS.pdf`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: PDF document (600 pages).

**Pages:** 600 **Report tool:** TESSY

---

## Test report summary

This is an automatically generated unit-test report with **600 pages**. Only the summary is reproduced here; the full step-by-step report remains in the repository.

| Item | Value |
| --- | --- |
| Detail | Test Object "CBD_UnitTest/VehDyn/VehDyn_Per1" |
...
No. Name C0 C1 MC/DC MCC Test Cases Result
 VehDyn 100 % 100 % 100 % 100 % 3 of 3 passed
 CBD_UnitTest 100 % 100 % 100 % 100 % 3 of 3 passed
 VehDyn 100 % 100 % 100 % 100 % 3 of 3 passed
1 VehDyn_Per1 100 % 100 % 100 % 100 % 3 of 3 passed
```
