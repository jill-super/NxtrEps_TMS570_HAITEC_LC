...
> **Source document:** `VehDyn/utp/Tessy/report/index_WithPS.pdf`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: PDF document (601 pages).

**Pages:** 601 **Report tool:** TESSY

---

## Test report summary

This is an automatically generated unit-test report with **601 pages**. Only the summary is reproduced here; the full step-by-step report remains in the repository.

| Item | Value |
| --- | --- |
| Detail | Test Object "CBD_UnitTest/VehDyn/Autocenter_f32" |
...
```text
TEST OVERVIEW REPORT 2014-09-19, 20:50:58+0530
Project VehDyn
...
Test Object "CBD_UnitTest/VehDyn/VehDyn_SCom"
...
No. Name C0 C1 MC/DC MCC Test Cases Result
 VehDyn 100 % 100 % 100 % 100 % 13 of 13 passed
 CBD_UnitTest 100 % 100 % 100 % 100 % 13 of 13 passed
 VehDyn 100 % 100 % 100 % 100 % 13 of 13 passed
1 Autocenter_f32 100 % 100 % 100 % 100 % 3 of 3 passed
2 VehDyn_Init1 100 % 100 % 100 % 100 % 3 of 3 passed
3 VehDyn_Per1 100 % 100 % 100 % 100 % 3 of 3 passed
4 VehDyn_SCom 100 % 100 % - - 1 of 1 passed
5 VehDyn_Trns1 100 % 100 % 100 % 100 % 3 of 3 passed
```
