---
title: "Sweep1 Module Design Document"
description: "Converted from Sweep1_MDD.docx"
---

> **Source document:** `Sweep/doc/Sweep1_MDD.docx`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: Word document (`.docx`, 86 paragraphs, 13 tables, 1 embedded figures).

**Author:** Vishal Kema **Last saved by:** Vishal Kema **Revision:** 74
...
![Embedded figure](sweep1-mdd-fig1.png)
