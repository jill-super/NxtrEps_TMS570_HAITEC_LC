---
title: "StabilityCompensation2 Module Design Document"
description: "Converted from StabilityCompensation2_MDD.docx"
---

> **Source document:** `StabilityComp/doc/StabilityCompensation2_MDD.docx`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: Word document (`.docx`, 123 paragraphs, 14 tables, 1 embedded figures).

**Last saved by:** Thomas, Vince **Revision:** 32
...
![Embedded figure](stabilitycompensation2-mdd-fig1.png)
