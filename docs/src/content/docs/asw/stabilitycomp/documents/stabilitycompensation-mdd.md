---
title: "StabilityCompensation Module Design Document"
description: "Converted from StabilityCompensation_MDD.docx"
---

> **Source document:** `StabilityComp/doc/StabilityCompensation_MDD.docx`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: Word document (`.docx`, 125 paragraphs, 14 tables, 1 embedded figures).

**Last saved by:** Thomas, Vince **Revision:** 150
...
![Embedded figure](stabilitycompensation-mdd-fig1.png)
