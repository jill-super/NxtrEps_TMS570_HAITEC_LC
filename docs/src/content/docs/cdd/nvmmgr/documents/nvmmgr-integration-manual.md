---
title: "NvMMgr Integration Manual"
description: "Converted from NvMMgr_Integration_Manual.docx"
---

> **Source document:** `NvMMgr/doc/NvMMgr_Integration_Manual.docx`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: Word document (`.docx`, 177 paragraphs, 17 tables, 0 embedded figures).

**Author:** Jeremy Warmbier **Last saved by:** Smith, Kevin **Revision:** 4
