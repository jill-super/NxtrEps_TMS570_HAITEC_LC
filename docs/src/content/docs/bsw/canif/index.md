---
title: "Controller Area Network Interface (CanIf)"
description: "Vector MICROSAR CanIf: role, repository files and configuration."
---
...
Abstracts the CAN hardware: transmit/receive routing between the CAN driver, transceivers and upper layers.
...
| File |
| --- |
| `Haitec_LC_EPS_TMS570/SwProject/Source/BSW/CanIf/CanIf.c` |
| `Haitec_LC_EPS_TMS570/SwProject/Source/BSW/CanIf/CanIf.h` |
| `Haitec_LC_EPS_TMS570/SwProject/Source/BSW/CanIf/CanIf_Cbk.h` |
| `Haitec_LC_EPS_TMS570/SwProject/Source/BSW/CanIf/CanIf_Types.h` |

_The module directory holds 8 tracked files._
