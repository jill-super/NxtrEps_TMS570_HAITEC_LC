...
description: "Vector MICROSAR Mcu: role, repository files and configuration."
---
...
Microcontroller initialisation: clock, phase-locked loop, reset handling and power modes.
...
| File |
| --- |
| `Haitec_LC_EPS_TMS570/SwProject/Source/BSW/Mcu/Mcu.c` |
| `Haitec_LC_EPS_TMS570/SwProject/Source/BSW/Mcu/Mcu.h` |
...
- `Haitec_LC_EPS_TMS570/SwProject/Source/GenData/Mcu_Cfg.h`
- `Haitec_LC_EPS_TMS570/SwProject/Source/GenData/Mcu_PBcfg.c`
