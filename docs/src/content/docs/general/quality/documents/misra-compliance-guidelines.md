...
description: "Converted from MISRA Compliance Guidelines.docx"
---

> **Source document:** `QAC/doc/MISRA Compliance Guidelines.docx`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: Word document (`.docx`, 232 paragraphs, 5 tables, 10 embedded figures).

**Author:** Balani, Spandana **Last saved by:** Newton, Lonnie **Revision:** 2

---

**MISRA ****Compliance Guideline****s**** **
...
- ![Embedded figure](misra-compliance-guidelines-fig1.png)

- After clicking the ‘New Project’ a New Project Parameters window will pop up as shown

- ![Embedded figure](misra-compliance-guidelines-fig2.png)
...
![Embedded figure](misra-compliance-guidelines-fig3.png)

- After clicking okay, a <Component Name> folder will be visible in the Project Folders pane as shown below.

![Embedded figure](misra-compliance-guidelines-fig4.png)
...
![Embedded figure](misra-compliance-guidelines-fig5.png)

- Now right click on the sub folder and click on Add Files.

- ![Embedded figure](misra-compliance-guidelines-fig6.png)

- Select the C files from <Component Name>\src and click **‘Open’**.

- ![Embedded figure](misra-compliance-guidelines-fig7.png)
...
![Embedded figure](misra-compliance-guidelines-fig8.png)
...
- The QAC Project file for the customers is stored in respective project folders – Application – Version – Source Files - zip folder at ![Embedded figure](misra-compliance-guidelines-fig9.gif)![Embedded figure](misra-compliance-guidelines-fig10.gif) >  > EA 3.x.
