...
> **Source document:** `MtrVel_Digi/utp/Tessy/report/MtrVel_Digi/index_WithOutPS.pdf`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: PDF document (193 pages).

**Pages:** 193 **Report tool:** TESSY

---

## Test report summary

This is an automatically generated unit-test report with **193 pages**. Only the summary is reproduced here; the full step-by-step report remains in the repository.

| Item | Value |
| --- | --- |
| Detail | Test Object "CBD_UnitTest/MtrVel_Digi/CalcCoarseVel" |
...
No. Name C0 C1 DC MC/DC MCC Test Cases Result
 MtrVel_Digi 100 % 100 % 100 % 100 % 100 % 13 of 13 passed
 CBD_UnitTest 100 % 100 % 100 % 100 % 100 % 13 of 13 passed
 MtrVel_Digi 100 % 100 % 100 % 100 % 100 % 13 of 13 passed
1 CalcCoarseVel 100 % 100 % - - - 1 of 1 passed
2 MtrVel_Init 100 % 100 % - - - 1 of 1 passed
3 MtrVel_Per1 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
4 MtrVel_Per2 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
5 MtrVelBlend 100 % 100 % 100 % 100 % 100 % 2 of 2 passed
6 RegressionFit 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
```
