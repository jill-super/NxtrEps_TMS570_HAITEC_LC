...
> **Source document:** `MtrVel_Digi/utp/Tessy/report/MtrVel_Digi2/index_WithOutPS.pdf`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: PDF document (67 pages).

**Pages:** 67 **Report tool:** TESSY

---

## Test report summary

This is an automatically generated unit-test report with **67 pages**. Only the summary is reproduced here; the full step-by-step report remains in the repository.

| Item | Value |
| --- | --- |
| Detail | Test Object "CBD_UnitTest/MtrVel2/MtrVel2_Init" |
...
| Detail | Report created by TESSY V3.1.9 |
...
TEST OVERVIEW REPORT 2015-01-08, 12:30:13+0530
Project MtrVel_Digi
© Report created by TESSY V3.1.9, report template V2.0 2
...
TEST OVERVIEW REPORT 2015-01-08, 12:30:13+0530
Project MtrVel_Digi
© Report created by TESSY V3.1.9, report template V2.0 3
...
TEST OVERVIEW REPORT 2015-01-08, 12:30:13+0530
Project MtrVel_Digi
© Report created by TESSY V3.1.9, report template V2.0 4
Test Object List
...
No. Name C0 C1 DC MC/DC MCC Test Cases Result
 MtrVel_Digi 100 % 100 % 100 % 100 % 100 % 7 of 7 passed
 CBD_UnitTest 100 % 100 % 100 % 100 % 100 % 7 of 7 passed
 MtrVel2 100 % 100 % 100 % 100 % 100 % 7 of 7 passed
1 MtrVel2_Init 100 % 100 % - - - 1 of 1 passed
2 MtrVel2_Per1 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
3 MtrVel2_Per2 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
```
