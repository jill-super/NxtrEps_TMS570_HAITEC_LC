---
title: "Unit-Test Report (with Power Steering with Fault Injection)"
description: "Tessy unit-test report summary"
---

> **Source document:** `DigHwTrqSENT/utp/Tessy/report/index_WithPS_FLTINJ.pdf`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: PDF document (220 pages).

**Pages:** 220 **Report tool:** TESSY

---

## Test report summary

This is an automatically generated unit-test report with **220 pages**. Only the summary is reproduced here; the full step-by-step report remains in the repository.
...
No. Name C0 C1 DC MC/DC MCC Test Cases Result
 CBD_DigHwTrqSENT 54.37 % 50 % 49.01 % 51.37 % 51.37 % 20 of 21 passed
 CBD_UnitTest 54.37 % 50 % 49.01 % 51.37 % 51.37 % 20 of 21 passed
 DigHwTrqSENT_FLTINJ 54.37 % 50 % 49.01 % 51.37 % 51.37 % 20 of 21 passed
