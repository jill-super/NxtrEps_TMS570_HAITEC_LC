...
> **Source document:** `DigHwTrqSENT/utp/Tessy/report/index_WithOutPS.pdf`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: PDF document (217 pages).

**Pages:** 217 **Report tool:** TESSY

---

## Test report summary

This is an automatically generated unit-test report with **217 pages**. Only the summary is reproduced here; the full step-by-step report remains in the repository.

| Item | Value |
| --- | --- |
| Detail | Test Object "CBD_UnitTest/DigHwTrqSENT/DigHwTrqSENT_Init1" |
...
Test Object "CBD_UnitTest/DigHwTrqSENT/DigHwTrqSENT_SCom_TrimData"
Test Object "CBD_UnitTest/DigHwTrqSENT/DigHwTrqSENT_SCom_WriteData"
Test Object "CBD_UnitTest/DigHwTrqSENT/TrimNotPerfDiag"
...
No. Name C0 C1 DC MC/DC MCC Test Cases Result
 ...
 DigHwTrqSENT 54.65 % 50.47 % 49.01 % 51.37 % 51.37 % 21 of 21 passed
...
8 DigHwTrqSENT_SCom_WriteData 100 % 100 % - - - 1 of 1 passed
9 TrimNotPerfDiag 100 % 100 % 100 % 100 % 100 
```
