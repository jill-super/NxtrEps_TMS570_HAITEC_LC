---
title: "DigtalMSB Module Design Document"
description: "Converted from DigtalMSB_MDD.docx"
---

> **Source document:** `DigMSB/doc/DigtalMSB_MDD.docx`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: Word document (`.docx`, 201 paragraphs, 14 tables, 0 embedded figures).

**Author:** nzt9hv **Last saved by:** Ahmed, Rijvi **Revision:** 55
