...
> **Source document:** `DigMSB/utp/Tessy/report/index_WithOutPS.pdf`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: PDF document (5843 pages).

**Pages:** 5843 **Report tool:** TESSY

---

## Test report summary

This is an automatically generated unit-test report with **5843 pages**. Only the summary is reproduced here; the full step-by-step report remains in the repository.

| Item | Value |
| --- | --- |
| Detail | Test Object "CBD_UnitTest/DiagMSB/DigMSB_Init" |
...
No. Name C0 C1 DC MC/DC MCC Test Cases Result
 DigMSB 66.15 % 65.56 % 65.44 % 67.24 % 67.24 % 17 of 17 passed
 CBD_UnitTest 66.15 % 65.56 % 65.44 % 67.24 % 67.24 % 17 of 17 passed
 DiagMSB 66.15 % 65.56 % 65.44 % 67.24 % 67.24 % 17 of 17 passed
1 DigMSB_Init 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
2 DigMSB_Per1 49.23 % 47.72 % 47.72 % 47.72 % 47.72 % 3 of 3 passed
3 DigMSB_Per2 74.9 % 75 % 75 % 76.92 % 76.92 % 3 of 3 passed
4 DigMSB_Per3 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
5 ErrorRegisterProcessing 100 % 100 % - - - 1 of 1 passed
6 MtrPosProcessing 19.56 % 13.33 % 13.33 % 13.33 % 13.33 % 1 of 1 passed
7 RevCntrProcessing 100 % 100 % 100 % 100 % 100 % 3 of 3 passed
```
