---
title: "Temporal Monitor Module Design Document"
description: "Converted from Temporal_Monitor_MDD.docx"
---

> **Source document:** `TmprlMon/doc/Temporal_Monitor_MDD.docx`
>
> This page was converted automatically from the original document so it can be browsed online. Original format: Word document (`.docx`, 156 paragraphs, 13 tables, 1 embedded figures).

**Author:** Owen Tosh (nzx5jd) **Last saved by:** Jared Julien (kzdyfh) **Revision:** 61
...
![Embedded figure](temporal-monitor-mdd-fig1.png)
