...
struct Rte_CDS_Ap_ActivePull
{
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_ACTIVEPULL_APPL_VAR) ActivePull_Per1_SrlComYawRate_DegpS_f32;
...
#    error "The magic number of the generated file <C:/CMSynergy_Projects/ActivePull/utp/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
