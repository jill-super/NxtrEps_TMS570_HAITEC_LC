...
# define Rte_InitValue_MechMtrPos1_Rev_f32 ((Float)0)
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_Ap_VehDyn_NVM_VehDynReset_Srv_ReadBlock(P2VAR(UInt8, AUTOMATIC, RTE_AP_VEHDYN_APPL_VAR) DstPtr);
# else
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_Ap_VehDyn_NVM_VehDynReset_Srv_ReadBlock(P2VAR(NvM_DestPtr, AUTOMATIC, RTE_AP_VEHDYN_APPL_VAR) DstPtr);
# endif
# ifdef RTE_PTR2ARRAYBASETYPE_PASSING
...
# define Rte_IRead_VehDyn_Trns1_MechMtrPos1_Rev_f32() \
  (Rte_Inst_Ap_VehDyn->VehDyn_Trns1_MechMtrPos1_Rev_f32->value)
 ...
 *********************************************************************************************************************/
# define Rte_Call_NVM_VehDynReset_Srv_ReadBlock Rte_Call_Ap_VehDyn_NVM_VehDynReset_Srv_ReadBlock
...
#    error "The magic number of the generated file <C:/SynergyWorkspace/WorkingProjects/VehDyn-gzkys7/VehDyn/utp/contract/Ap_VehDyn/Rte_Ap_VehDyn.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
