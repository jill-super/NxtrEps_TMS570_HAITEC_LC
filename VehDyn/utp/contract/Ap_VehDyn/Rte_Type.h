...
struct Rte_CDS_Ap_VehDyn
{
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_VEHDYN_APPL_VAR) VehDyn_Trns1_MechMtrPos1_Rev_f32;
  /* PIM Handles section */
...
#    error "The magic number of the generated file <C:/SynergyWorkspace/WorkingProjects/VehDyn-gzkys7/VehDyn/utp/contract/Ap_VehDyn/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
