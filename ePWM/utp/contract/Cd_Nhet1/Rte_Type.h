...
struct Rte_CDS_Cd_Nhet1
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_CD_NHET1_APPL_VAR) Nhet1_Per2_DigHwTrqT1_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_CD_NHET1_APPL_VAR) Nhet1_Per2_DigHwTrqT2_HwNm_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Cd_Nhet1, RTE_CONST, RTE_CONST) Rte_Inst_Cd_Nhet1;
...
#    error "The magic number of the generated file <C:/Rijvi_Synergy_EA3/Core_Component/Working/ePWM/utp/contract/Cd_Nhet1/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
