...
struct Rte_CDS_Ap_HaitecTrqCmd
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HAITECTRQCMD_APPL_VAR) HaitecTrqCmd_Per1_AssitMechTempEst_DegC_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HAITECTRQCMD_APPL_VAR) HaitecTrqCmd_Per1_HwTrq_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HAITECTRQCMD_APPL_VAR) HaitecTrqCmd_Per1_MtrVelCRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_HAITECTRQCMD_APPL_VAR) HaitecTrqCmd_Per1_VehSpd_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_HaitecTrqCmd, RTE_CONST, RTE_CONST) Rte_Inst_Ap_HaitecTrqCmd;
...
#    error "The magic number of the generated file <C:/HaitecTrqCmd/HaitecTrqCmd/tools/contract/Ap_HaitecTrqCmd/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
