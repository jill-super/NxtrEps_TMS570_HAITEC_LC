...
#    error "The magic number of the generated file <C:/HaitecTrqCmd/HaitecTrqCmd/tools/contract/Ap_HaitecTrqCmd/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
