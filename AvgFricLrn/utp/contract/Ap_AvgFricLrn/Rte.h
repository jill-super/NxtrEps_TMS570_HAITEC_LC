...
#    error "The magic number of the generated file <C:/CM_Synergy/ccm_wa/Working/CBD/AvgFricLrn/AvgFricLrn/utp/contract/Ap_AvgFricLrn/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
