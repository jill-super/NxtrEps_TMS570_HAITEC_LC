...
struct Rte_CDS_Ap_AvgFricLrn
{
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_AVGFRICLRN_APPL_VAR) AvgFricLrn_Per1_LatAcc_g_f32;
...
#    error "The magic number of the generated file <C:/CM_Synergy/ccm_wa/Working/CBD/AvgFricLrn/AvgFricLrn/utp/contract/Ap_AvgFricLrn/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
