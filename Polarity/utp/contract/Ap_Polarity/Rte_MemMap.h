...
#   error "The magic number of the generated file <C:/CMSynergy_Projects/Polarity/utp/contract/Ap_Polarity/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
