...
struct Rte_CDS_Ap_Polarity
{
  ...
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_POLARITY_APPL_VAR) Polarity_Per1_DiagAssistAssyPolarity_Cnt_s08;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_POLARITY_APPL_VAR) Polarity_Per1_DiagHwPosPolarity_Cnt_s08;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_POLARITY_APPL_VAR) Polarity_Per1_DiagHwTrqPolarity_Cnt_s08;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_POLARITY_APPL_VAR) Polarity_Per1_DiagMtrElecMechPolarity_Cnt_s08;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_POLARITY_APPL_VAR) Polarity_Per1_DiagMtrPosPolarity_Cnt_s08;
  P2VAR(Rte_DE_SInt8, TYPEDEF, RTE_AP_POLARITY_APPL_VAR) Polarity_Per1_DiagMtrVelPolarity_Cnt_s08;
  /* PIM Handles section */
...
#    error "The magic number of the generated file <C:/CMSynergy_Projects/Polarity/utp/contract/Ap_Polarity/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
