...
#   error "The magic number of the generated file <C:/Rijvi_Synergy/Core_Component/Working/DigMSB-jzk9cc/DigMSB/utp/contract/Sa_DigMSB/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
