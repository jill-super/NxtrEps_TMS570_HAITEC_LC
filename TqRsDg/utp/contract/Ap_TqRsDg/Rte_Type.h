...
struct Rte_CDS_Ap_TqRsDg
{
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TQRSDG_APPL_VAR) TqRsDg_Per1_DervLambdaAlphaDiag_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_TQRSDG_APPL_VAR) TqRsDg_Per1_DervLambdaBetaDiag_Volt_f32;
...
#    error "The magic number of the generated file <C:/Users/nzt9hv/Documents/Synergy/ccm_wa/ESG_Dev_65/TqRsDg-nzt9hv2/TqRsDg/utp/contract/Ap_TqRsDg/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
