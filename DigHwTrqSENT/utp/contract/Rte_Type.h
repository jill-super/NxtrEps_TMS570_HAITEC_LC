...
struct Rte_CDS_Sa_DigHwTrqSENT
{
  /* Data Handles section */
  P2VAR(Rte_DE_ManufModeType, TYPEDEF, RTE_SA_DIGHWTRQSENT_APPL_VAR) DigHwTrqSENT_Init1_MECCounter_Cnt_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_DIGHWTRQSENT_APPL_VAR) DigHwTrqSENT_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_DIGHWTRQSENT_APPL_VAR) DigHwTrqSENT_Per1_SysCHwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_DIGHWTRQSENT_APPL_VAR) DigHwTrqSENT_Per1_T1_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_DIGHWTRQSENT_APPL_VAR) DigHwTrqSENT_Per1_T2_HwNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_DIGHWTRQSENT_APPL_VAR) DigHwTrqSENT_Per2_SrlComHwTrqValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_DIGHWTRQSENT_APPL_VAR) DigHwTrqSENT_Per2_SrlComHwTrq_HwNm_f32;
  /* PIM Handles section */
  P2VAR(DigHwTrqSENTTrim_DataType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_DigTrqTrim;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_DigHwTrqSENT, RTE_CONST, RTE_CONST) Rte_Inst_Sa_DigHwTrqSENT;
...
#    error "The magic number of the generated file <C:/_00_Working_Files/_19_EA3.0_Work/03_Component_Development/DigHwTrqSENT/utp/contract/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
