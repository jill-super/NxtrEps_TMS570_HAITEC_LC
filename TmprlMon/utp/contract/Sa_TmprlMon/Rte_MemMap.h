...
#   error "The magic number of the generated file <C:/Workspace/TmprlMon-CBD_TmprlMon/FDD19B/TmprlMon/utp/contract/Sa_TmprlMon/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
