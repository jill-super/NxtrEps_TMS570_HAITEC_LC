...
struct Rte_CDS_Ap_DampingFirewall
{
  /* Data Handles section */
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DAMPINGFIREWALL_APPL_VAR) DampingFirewall_Per1_AsstFirewallActive_Uls_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DAMPINGFIREWALL_APPL_VAR) DampingFirewall_Per1_BaseAssistCmd_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DAMPINGFIREWALL_APPL_VAR) DampingFirewall_Per1_CombinedDamping_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DAMPINGFIREWALL_APPL_VAR) DampingFirewall_Per1_DampingCmd_MtrNm_f32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_DAMPINGFIREWALL_APPL_VAR) DampingFirewall_Per1_Defeat_Damping_Svc_Cnt_lgc;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_DAMPINGFIREWALL_APPL_VAR) DampingFirewall_Per1_FreqDepDmpSrlComSvcDft_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DAMPINGFIREWALL_APPL_VAR) DampingFirewall_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DAMPINGFIREWALL_APPL_VAR) DampingFirewall_Per1_InertiaComp_MtrNm_f32;
  P2VAR(Rte_DE_ManufModeType, TYPEDEF, RTE_AP_DAMPINGFIREWALL_APPL_VAR) DampingFirewall_Per1_MEC_Counter_Cnt_enum;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DAMPINGFIREWALL_APPL_VAR) DampingFirewall_Per1_MtrVelCRF_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DAMPINGFIREWALL_APPL_VAR) DampingFirewall_Per1_VehicleLonAccel_KphpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DAMPINGFIREWALL_APPL_VAR) DampingFirewall_Per1_VehicleSpeed_Kph_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_DAMPINGFIREWALL_APPL_VAR) DampingFirewall_Per1_WIRCmdAmpBlnd_MtrNm_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_DampingFirewall, RTE_CONST, RTE_CONST) Rte_Inst_Ap_DampingFirewall;
...
#    error "The magic number of the generated file <C:/Synergy_projects/DampingFirewall-lz4p8n/DampingFirewall/utp/contract/Ap_DampingFirewall/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
