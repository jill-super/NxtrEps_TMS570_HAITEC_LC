...
#    error "The magic number of the generated file <C:/Synergy_projects/DampingFirewall-lz4p8n/DampingFirewall/utp/contract/Ap_DampingFirewall/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
