...
struct Rte_CDS_Ap_CurrCmd
{
  ...
  P2VAR(Rte_DE_SInt16, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_MtrTrqCmdSign_Cnt_s16;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_MtrVoltDaxFF_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_CURRCMD_APPL_VAR) CurrCmd_Per1_MtrVoltQaxFF_Volt_f32;
...
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/MtrCtrl_CM-nzt9hv/MtrCtrl_CM/utp/contract/Ap_CurrCmd/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
