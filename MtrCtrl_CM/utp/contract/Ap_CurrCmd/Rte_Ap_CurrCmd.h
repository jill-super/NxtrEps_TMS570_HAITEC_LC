 ...
 *  Generated at:  Tue Nov 26 16:56:00 2013
 *
...
# define Rte_InitValue_MtrTrqCmdSign_Cnt_s16 ((SInt16)0)
# define Rte_InitValue_MtrVoltDaxFF_Volt_f32 ((Float)0)
# define Rte_InitValue_MtrVoltQaxFF_Volt_f32 ((Float)0)
...
# define Rte_IWrite_CurrCmd_Per1_MtrTrqCmdSign_Cnt_s16(data) \
  ( \
  Rte_Inst_Ap_CurrCmd->CurrCmd_Per1_MtrTrqCmdSign_Cnt_s16->value = (data) \
  )

# define Rte_IWriteRef_CurrCmd_Per1_MtrTrqCmdSign_Cnt_s16() \
  (&Rte_Inst_Ap_CurrCmd->CurrCmd_Per1_MtrTrqCmdSign_Cnt_s16->value)

# define Rte_IWrite_CurrCmd_Per1_MtrVoltDaxFF_Volt_f32(data) \
  ( \
  Rte_Inst_Ap_CurrCmd->CurrCmd_Per1_MtrVoltDaxFF_Volt_f32->value = (data) \
  )

# define Rte_IWriteRef_CurrCmd_Per1_MtrVoltDaxFF_Volt_f32() \
  (&Rte_Inst_Ap_CurrCmd->CurrCmd_Per1_MtrVoltDaxFF_Volt_f32->value)

# define Rte_IWrite_CurrCmd_Per1_MtrVoltQaxFF_Volt_f32(data) \
  ( \
  Rte_Inst_Ap_CurrCmd->CurrCmd_Per1_MtrVoltQaxFF_Volt_f32->value = (data) \
  )

# define Rte_IWriteRef_CurrCmd_Per1_MtrVoltQaxFF_Volt_f32() \
  (&Rte_Inst_Ap_CurrCmd->CurrCmd_Per1_MtrVoltQaxFF_Volt_f32->value)
...
#   if RTE_MAGIC_NUMBER != 1385501987
#    error "The magic number of the generated file <C:/Documents and Settings/nzt9hv/My Documents/Synergy/ccm_wa/ESG_Dev_65/MtrCtrl_CM-nzt9hv/MtrCtrl_CM/utp/contract/Ap_CurrCmd/Rte_Ap_CurrCmd.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1385501987
