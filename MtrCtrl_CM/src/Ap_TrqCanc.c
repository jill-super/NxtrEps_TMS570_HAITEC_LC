 ...
 *  Generated at:  Wed Nov  6 11:14:11 2013
 *
...
typedef struct
{
	sint16 CoggingMX_Amp_s6p9 ;
	sint16 CoggingMY_Amp_s6p9;
...
STATIC VAR(float32, Ap_TrqCanc_VAR_NOINIT) TrqCanc_CorrecNomKe_VpRadpS_M_f32;
STATIC volatile VAR(float32, Ap_TrqCanc_VAR_NOINIT) CoggingTrqCanc_MtrNm_D_f32;
STATIC volatile VAR(float32, Ap_TrqCanc_VAR_NOINIT) MtrCurrQax6thMag_Amp_D_f32;
STATIC volatile VAR(float32, Ap_TrqCanc_VAR_NOINIT)	MtrCurrQax12thMag_Amp_D_f32;
STATIC volatile VAR(float32, Ap_TrqCanc_VAR_NOINIT)	MtrCurrQax18thMag_Amp_D_f32;
STATIC volatile VAR(float32, Ap_TrqCanc_VAR_NOINIT) MtrCurrQax18thMagFinal_Amp_D_f32;
STATIC volatile VAR(float32, Ap_TrqCanc_VAR_NOINIT) MtrTrqRip18thPhsFinal_Rad_D_f32;
STATIC volatile VAR(float32, Ap_TrqCanc_VAR_NOINIT) MtrCurrQax6thMagFinal_Amp_D_f32;
STATIC volatile VAR(float32, Ap_TrqCanc_VAR_NOINIT) MtrTrqRip6thPhsFinal_Rad_D_f32;
STATIC volatile VAR(float32, Ap_TrqCanc_VAR_NOINIT) MtrCurrQax12thMagFinal_Amp_D_f32;
STATIC volatile VAR(float32, Ap_TrqCanc_VAR_NOINIT) MtrTrqRip12thPhsFinal_Rad_D_f32;
STATIC  volatile VAR(float32, Ap_TrqCanc_VAR_NOINIT) CoggingTrqMtrPosElec_Rev_D_f32;
STATIC volatile VAR(float32, Ap_TrqCanc_VAR_NOINIT) MtrTrqRip6thPhs_Rad_D_f32;
STATIC volatile VAR(float32, Ap_TrqCanc_VAR_NOINIT)	MtrTrqRip12thPhs_Rad_D_f32;
STATIC volatile VAR(float32, Ap_TrqCanc_VAR_NOINIT)	MtrTrqRip18thPhs_Rad_D_f32;
STATIC VAR(float32, Ap_TrqCanc_VAR_NOINIT) MtrCurrQax6Mag_Amp_M_f32[2];
STATIC VAR(float32, Ap_TrqCanc_VAR_NOINIT) MtrCurrQax12Mag_Amp_M_f32[2];
STATIC VAR(float32, Ap_TrqCanc_VAR_NOINIT) MtrCurrQax6Ph_Rad_M_f32[2];
STATIC VAR(float32, Ap_TrqCanc_VAR_NOINIT) MtrCurrQax12Ph_Rad_M_f32[2];
STATIC VAR(float32, Ap_TrqCanc_VAR_NOINIT) MtrCurrQax18Mag_Amp_M_f32[2];
STATIC VAR(float32, Ap_TrqCanc_VAR_NOINIT) MtrCurrQax18Ph_Rad_M_f32[2];
#define TRQCANC_STOP_SEC_VAR_CLEARED_32
#include "MemMap.h" /* PRQA S 5087 */

#define TRQCANC_START_SEC_VAR_CLEARED_16
#include "MemMap.h"  /* PRQA S 5087 */
STATIC volatile VAR(uint16, Ap_TrqCanc_VAR_NOINIT) CogginTrqCancIndex_Cnt_D_u16;
VAR(uint16, AUTOMATIC)  SlowDataAccessBufIndex_Cnt_M_u16;
STATIC  VAR(sint16, Ap_TrqCanc_VAR_NOINIT)  TrqCanc_MtrCurrQaxRpl6X_Amp_M_s6p9[D_DAXRPLTBLSZ_CNT_U8][D_QAXRPLTBLSZ_CNT_U8] ;
STATIC  VAR(sint16, Ap_TrqCanc_VAR_NOINIT)  TrqCanc_MtrCurrQaxRpl6Y_Amp_M_s6p9[D_DAXRPLTBLSZ_CNT_U8][D_QAXRPLTBLSZ_CNT_U8] ;
STATIC  VAR(sint16, Ap_TrqCanc_VAR_NOINIT)  TrqCanc_MtrCurrQaxRpl12X_Amp_M_s6p9[D_DAXRPLTBLSZ_CNT_U8][D_QAXRPLTBLSZ_CNT_U8] ;
STATIC  VAR(sint16, Ap_TrqCanc_VAR_NOINIT)  TrqCanc_MtrCurrQaxRpl12Y_Amp_M_s6p9[D_DAXRPLTBLSZ_CNT_U8][D_QAXRPLTBLSZ_CNT_U8];
STATIC  VAR(sint16, Ap_TrqCanc_VAR_NOINIT)  TrqCanc_MtrCurrQaxRpl18X_Amp_M_s6p9[D_DAXRPLTBLSZ_CNT_U8][D_QAXRPLTBLSZ_CNT_U8] ;
STATIC  VAR(sint16, Ap_TrqCanc_VAR_NOINIT)  TrqCanc_MtrCurrQaxRpl18Y_Amp_M_s6p9[D_DAXRPLTBLSZ_CNT_U8][D_QAXRPLTBLSZ_CNT_U8];
#define TRQCANC_STOP_SEC_VAR_CLEARED_16
#include "MemMap.h" /* PRQA S 5087 */

#define TRQCANC_START_SEC_CONST_16
#include "MemMap.h"  /* PRQA S 5087 */
STATIC CONST(uint16, AUTOMATIC) t_SinTbl_Cnt_u16[513] =
 ...
 *********************************************************************************************************************/
	...
	TrqCanc_CorrecNomKe_VpRadpS_M_f32 = (D_SQRT3OVR2_ULS_F32 * (Rte_IRead_TrqCanc_Init_EstKe_VpRadpS_f32()));
...
VAR(float32, AUTOMATIC) MtrCurrQaxRpl6X_Amp_T_f32;
VAR(float32, AUTOMATIC) MtrCurrQaxRpl6Y_Amp_T_f32;
VAR(float32, AUTOMATIC) MtrCurrQaxRpl12X_Amp_T_f32;
VAR(float32, AUTOMATIC) MtrCurrQaxRpl12Y_Amp_T_f32;
VAR(float32, AUTOMATIC) MtrCurrQaxRpl18X_Amp_T_f32;
VAR(float32, AUTOMATIC) MtrCurrQaxRpl18Y_Amp_T_f32;
VAR(float32, AUTOMATIC) MtrCurrQax6thMag_Amp_T_f32;
VAR(float32, AUTOMATIC) MtrCurrQax12thMag_Amp_T_f32;
VAR(float32, AUTOMATIC) MtrCurrQax18thMag_Amp_T_f32;
...
VAR(float32, AUTOMATIC)	 MtrCurrQax6thMagInt_Amp_T_f32;
VAR(float32, AUTOMATIC)	 MtrCurrQax12thMagInt_Amp_T_f32;
VAR(uint16, AUTOMATIC)	MtrTrqCancPI18thMagRP_Uls_T_u6p10;
VAR(uint16, AUTOMATIC)	MtrTrqCancPI18thPhRP_Rev_T_u0p16;
VAR(float32, AUTOMATIC)	 MtrCurrQax18thMagInt_Amp_T_f32;

VAR(sint16, AUTOMATIC) DaxRef_Amp_T_s8p7;
VAR(sint16, AUTOMATIC) QaxRef_Amp_T_s8p7;
VAR(sint16, AUTOMATIC) MtrCurrQaxRpl6X_Amp_T_s6p9;
VAR(sint16, AUTOMATIC) MtrCurrQaxRpl6Y_Amp_T_s6p9;
VAR(sint16, AUTOMATIC) MtrCurrQaxRpl12X_Amp_T_s6p9;
VAR(sint16, AUTOMATIC) MtrCurrQaxRpl12Y_Amp_T_s6p9;
VAR(sint16, AUTOMATIC) MtrCurrQaxRpl18X_Amp_T_s6p9;
VAR(sint16, AUTOMATIC) MtrCurrQaxRpl18Y_Amp_T_s6p9;
...
VAR(uint16, AUTOMATIC) WriteAccessBufIndex_Cnt_T_u16;
 ...
 /*****  Torque ripple compensation table Start*****/
	...
	MtrVel6thHarm_MtrRadpS_T_u16  = FPM_FloatToFixed_m((Abs_f32_m(MtrVel6thHarm_MtrRadpS_T_f32)), u16p0_T);
	MtrVel12thHarm_MtrRadpS_T_u16 =FPM_FloatToFixed_m((Abs_f32_m(MtrVel12thHarm_MtrRadpS_T_f32)), u16p0_T);
	MtrVel18thHarm_MtrRadpS_T_u16 =FPM_FloatToFixed_m((Abs_f32_m(MtrVel18thHarm_MtrRadpS_T_f32)), u16p0_T);	 
	
	DaxRef_Amp_T_s8p7=FPM_FloatToFixed_m(DaxRef_Amp_T_f32,s8p7_T);
	QaxRef_Amp_T_s8p7=FPM_FloatToFixed_m(QaxRef_Amp_T_f32,s8p7_T);
	
	
	
	
	/* 6thMag_TrqRipple */
	MtrCurrQaxRpl6X_Amp_T_s6p9 = BilinearXYM_s16_u16Xs16YM_Cnt(
		Abs_s16_m(DaxRef_Amp_T_s8p7),
		Abs_s16_m(QaxRef_Amp_T_s8p7),
		t_MtrCurrDaxRpl_Amp_u9p7,
		TableSize_m(t_MtrCurrDaxRpl_Amp_u9p7),
		t_MtrCurrQaxRpl_Amp_u9p7,
		TrqCanc_MtrCurrQaxRpl6X_Amp_M_s6p9[0],
		TableSize_m(t_MtrCurrQaxRpl_Amp_u9p7));
	
	/* 6thPhase_TrqRipple */
	MtrCurrQaxRpl6Y_Amp_T_s6p9 = BilinearXYM_s16_u16Xs16YM_Cnt(
		Abs_s16_m(DaxRef_Amp_T_s8p7),
		Abs_s16_m(QaxRef_Amp_T_s8p7),
		t_MtrCurrDaxRpl_Amp_u9p7,
		TableSize_m(t_MtrCurrDaxRpl_Amp_u9p7),
		t_MtrCurrQaxRpl_Amp_u9p7,
		TrqCanc_MtrCurrQaxRpl6Y_Amp_M_s6p9[0],
		TableSize_m(t_MtrCurrQaxRpl_Amp_u9p7));
	
	/* 12thMag_TrqRipple */
	MtrCurrQaxRpl12X_Amp_T_s6p9 = BilinearXYM_s16_u16Xs16YM_Cnt(
		Abs_s16_m(DaxRef_Amp_T_s8p7),
		Abs_s16_m(QaxRef_Amp_T_s8p7),
		t_MtrCurrDaxRpl_Amp_u9p7,
		TableSize_m(t_MtrCurrDaxRpl_Amp_u9p7),
		t_MtrCurrQaxRpl_Amp_u9p7,
		TrqCanc_MtrCurrQaxRpl12X_Amp_M_s6p9[0],
		TableSize_m(t_MtrCurrQaxRpl_Amp_u9p7));
	
	/* 12thPhase_TrqRipple */
	MtrCurrQaxRpl12Y_Amp_T_s6p9 = BilinearXYM_s16_u16Xs16YM_Cnt(
		Abs_s16_m(DaxRef_Amp_T_s8p7),
		Abs_s16_m(QaxRef_Amp_T_s8p7),
		t_MtrCurrDaxRpl_Amp_u9p7,
		TableSize_m(t_MtrCurrDaxRpl_Amp_u9p7),
		t_MtrCurrQaxRpl_Amp_u9p7,
		TrqCanc_MtrCurrQaxRpl12Y_Amp_M_s6p9[0],
		TableSize_m(t_MtrCurrQaxRpl_Amp_u9p7));
	
/* 18thMag_TrqRipple */
	MtrCurrQaxRpl18X_Amp_T_s6p9 = BilinearXYM_s16_u16Xs16YM_Cnt(
		Abs_s16_m(DaxRef_Amp_T_s8p7),
		Abs_s16_m(QaxRef_Amp_T_s8p7),
		t_MtrCurrDaxRpl_Amp_u9p7,
		TableSize_m(t_MtrCurrDaxRpl_Amp_u9p7),
		t_MtrCurrQaxRpl_Amp_u9p7,
		TrqCanc_MtrCurrQaxRpl18X_Amp_M_s6p9[0],
		TableSize_m(t_MtrCurrQaxRpl_Amp_u9p7));
	
	/* 18thPhase_TrqRipple */
	MtrCurrQaxRpl18Y_Amp_T_s6p9 = BilinearXYM_s16_u16Xs16YM_Cnt(
		Abs_s16_m(DaxRef_Amp_T_s8p7),
		Abs_s16_m(QaxRef_Amp_T_s8p7),
		t_MtrCurrDaxRpl_Amp_u9p7,
		TableSize_m(t_MtrCurrDaxRpl_Amp_u9p7),
		t_MtrCurrQaxRpl_Amp_u9p7,
		TrqCanc_MtrCurrQaxRpl18Y_Amp_M_s6p9[0],
		TableSize_m(t_MtrCurrQaxRpl_Amp_u9p7));	
	
	
	MtrCurrQaxRpl6X_Amp_T_f32 = FPM_FixedToFloat_m(MtrCurrQaxRpl6X_Amp_T_s6p9, s6p9_T);
	MtrCurrQaxRpl6Y_Amp_T_f32 = FPM_FixedToFloat_m(MtrCurrQaxRpl6Y_Amp_T_s6p9, s6p9_T);
	MtrCurrQaxRpl12X_Amp_T_f32 = FPM_FixedToFloat_m(MtrCurrQaxRpl12X_Amp_T_s6p9, s6p9_T);
	MtrCurrQaxRpl12Y_Amp_T_f32 = FPM_FixedToFloat_m(MtrCurrQaxRpl12Y_Amp_T_s6p9, s6p9_T);
	MtrCurrQaxRpl18X_Amp_T_f32 = FPM_FixedToFloat_m(MtrCurrQaxRpl18X_Amp_T_s6p9, s6p9_T);
	MtrCurrQaxRpl18Y_Amp_T_f32 = FPM_FixedToFloat_m(MtrCurrQaxRpl18Y_Amp_T_s6p9, s6p9_T);
	
	MtrCurrQax6thMagInt_Amp_T_f32 = sqrtf((MtrCurrQaxRpl6X_Amp_T_f32 * MtrCurrQaxRpl6X_Amp_T_f32) + (MtrCurrQaxRpl6Y_Amp_T_f32 * MtrCurrQaxRpl6Y_Amp_T_f32));
	MtrCurrQax12thMagInt_Amp_T_f32 = sqrtf((MtrCurrQaxRpl12X_Amp_T_f32 * MtrCurrQaxRpl12X_Amp_T_f32) + (MtrCurrQaxRpl12Y_Amp_T_f32 * MtrCurrQaxRpl12Y_Amp_T_f32));
	MtrCurrQax18thMagInt_Amp_T_f32 = sqrtf((MtrCurrQaxRpl18X_Amp_T_f32 * MtrCurrQaxRpl18X_Amp_T_f32) + (MtrCurrQaxRpl18Y_Amp_T_f32 * MtrCurrQaxRpl18Y_Amp_T_f32));
	
	MtrTrqRip6thPhsTemp_Rad_T_f32 = ((float32)Sign_f32_m(QaxRef_Amp_T_f32)) * (atan2f(MtrCurrQaxRpl6Y_Amp_T_f32, MtrCurrQaxRpl6X_Amp_T_f32));
	MtrTrqRip12thPhsTemp_Rad_T_f32 = ((float32)Sign_f32_m(QaxRef_Amp_T_f32)) * (atan2f(MtrCurrQaxRpl12Y_Amp_T_f32, MtrCurrQaxRpl12X_Amp_T_f32) );
	MtrTrqRip18thPhsTemp_Rad_T_f32 = ((float32)Sign_f32_m(QaxRef_Amp_T_f32)) * (atan2f(MtrCurrQaxRpl18Y_Amp_T_f32, MtrCurrQaxRpl18X_Amp_T_f32) );
	...
	MtrCurrQax6thMag_Amp_D_f32=MtrCurrQax6thMagInt_Amp_T_f32;
	MtrTrqRip6thPhs_Rad_D_f32=MtrTrqRip6thPhsTemp_Rad_T_f32;
	MtrCurrQax12thMag_Amp_D_f32=MtrCurrQax12thMagInt_Amp_T_f32;
	MtrTrqRip12thPhs_Rad_D_f32=MtrTrqRip12thPhsTemp_Rad_T_f32;
	MtrTrqRip18thPhs_Rad_D_f32=MtrTrqRip18thPhsTemp_Rad_T_f32;
	MtrCurrQax18thMag_Amp_D_f32=MtrCurrQax18thMagInt_Amp_T_f32;
	...
	MtrTrqCancPI6thMagRP_Uls_T_u6p10	=	BilinearXYM_u16_u16Xu16YM_Cnt(
													...
													TableSize_m(t_MtrCurrQaxRplPIY_Amp_u9p7)); 
	...
	MtrCurrQax6thMag_Amp_T_f32=MtrTrqCancPI6thMagRP_Uls_T_f32*MtrCurrQax6thMagInt_Amp_T_f32;
	MtrTrqRip6thPhs_Rad_T_f32=MtrTrqCancPI6thPhRPTemp_Rad_T_f32 + MtrTrqRip6thPhsTemp_Rad_T_f32;

	
	MtrCurrQax12thMag_Amp_T_f32=MtrTrqCancPI12thMagRP_Uls_T_f32*MtrCurrQax12thMagInt_Amp_T_f32;
	MtrTrqRip12thPhs_Rad_T_f32= MtrTrqCancPI12thPhRPTemp_Rad_T_f32 + MtrTrqRip12thPhsTemp_Rad_T_f32;

	
	MtrCurrQax18thMag_Amp_T_f32=MtrTrqCancPI18thMagRP_Uls_T_f32*MtrCurrQax18thMagInt_Amp_T_f32;
	...
	MtrCurrQax6thMagFinal_Amp_D_f32=MtrCurrQax6thMag_Amp_T_f32;
	MtrTrqRip6thPhsFinal_Rad_D_f32=MtrTrqRip6thPhs_Rad_T_f32;
	MtrCurrQax12thMagFinal_Amp_D_f32=MtrCurrQax12thMag_Amp_T_f32;
	MtrTrqRip12thPhsFinal_Rad_D_f32=MtrTrqRip12thPhs_Rad_T_f32;
	MtrTrqRip18thPhsFinal_Rad_D_f32=MtrTrqRip18thPhs_Rad_T_f32;
	MtrCurrQax18thMagFinal_Amp_D_f32=MtrCurrQax18thMag_Amp_T_f32;
	

	MtrCurrQax6Mag_Amp_M_f32[WriteAccessBufIndex_Cnt_T_u16] = MtrCurrQax6thMag_Amp_T_f32;
	MtrCurrQax12Mag_Amp_M_f32[WriteAccessBufIndex_Cnt_T_u16] = MtrCurrQax12thMag_Amp_T_f32;
	MtrCurrQax6Ph_Rad_M_f32[WriteAccessBufIndex_Cnt_T_u16] = MtrTrqRip6thPhs_Rad_T_f32;
	MtrCurrQax12Ph_Rad_M_f32[WriteAccessBufIndex_Cnt_T_u16]  = MtrTrqRip12thPhs_Rad_T_f32;
	MtrCurrQax18Mag_Amp_M_f32[WriteAccessBufIndex_Cnt_T_u16] = MtrCurrQax18thMag_Amp_T_f32;
	MtrCurrQax18Ph_Rad_M_f32[WriteAccessBufIndex_Cnt_T_u16] = MtrTrqRip18thPhs_Rad_T_f32;
...
STATIC FUNC(void, AUTOMATIC )  CoggingTrqTableUpdate( void)
{
	VAR(sint16,  AUTOMATIC) CogTrqCalCompX_T_MtrNm_s5p10;
	VAR(sint16,  AUTOMATIC) CogTrqCalCompY_T_MtrNm_s5p10;
	VAR(CoggingM_Amp_Str,  AUTOMATIC) CogTrqCalComp_T_Cnt_str[D_NOOFHARMONIC_CNT_U8];
	VAR(float32,  AUTOMATIC) CogTrqCalComp_T_Cnt_f32;
	...
	***/
	for (i=0u ; i < D_NOOFHARMONIC_CNT_U8; i++)
		{
		    if (TrqCanc_CorrecNomKe_VpRadpS_M_f32 > FLT_EPSILON)
		    	{
					CogTrqCalCompX_T_MtrNm_s5p10 = (sint16)((*(Rte_Pim_CogTrqRplComp()))[1u+(3u*i) ])	;
					CogTrqCalCompX_T_MtrNm_s5p10 = Limit_m(CogTrqCalCompX_T_MtrNm_s5p10,D_MINCOGRANGE_NM_S5P10, D_MAXCOGRANGE_NM_S5P10);
					CogTrqCalComp_T_Cnt_f32= (FPM_FixedToFloat_m(CogTrqCalCompX_T_MtrNm_s5p10 ,s5p10_T))/TrqCanc_CorrecNomKe_VpRadpS_M_f32;
					CogTrqCalComp_T_Cnt_str[i].CoggingMX_Amp_s6p9 = FPM_FloatToFixed_m(CogTrqCalComp_T_Cnt_f32 ,s6p9_T);
					CogTrqCalCompY_T_MtrNm_s5p10 = (sint16)((*(Rte_Pim_CogTrqRplComp()))[2u + (i*3u)])	;
					CogTrqCalCompY_T_MtrNm_s5p10 = Limit_m(CogTrqCalCompY_T_MtrNm_s5p10,D_MINCOGRANGE_NM_S5P10, D_MAXCOGRANGE_NM_S5P10);
					CogTrqCalComp_T_Cnt_f32= (FPM_FixedToFloat_m(CogTrqCalCompY_T_MtrNm_s5p10 ,s5p10_T))/TrqCanc_CorrecNomKe_VpRadpS_M_f32;
					CogTrqCalComp_T_Cnt_str[i].CoggingMY_Amp_s6p9 = FPM_FloatToFixed_m(CogTrqCalComp_T_Cnt_f32 ,s6p9_T);
		    	}
		    else
		    	{
		    		CogTrqCalComp_T_Cnt_str[i].CoggingMX_Amp_s6p9 =  D_ZERO_CNT_S8;
		    		CogTrqCalComp_T_Cnt_str[i].CoggingMY_Amp_s6p9 =  D_ZERO_CNT_S8;
		    	}
		}
	...
	for (i=0u;i<D_DAXRPLTBLSZ_CNT_U8;i++)
	{
		...
		{
			TrqCanc_MtrCurrQaxRpl6X_Amp_M_s6p9[i][j] =  t2_MtrCurrQaxRpl6X_Amp_s6p9[i][j]  +  CogTrqCalComp_T_Cnt_str[0].CoggingMX_Amp_s6p9;
			TrqCanc_MtrCurrQaxRpl6Y_Amp_M_s6p9[i][j] =  t2_MtrCurrQaxRpl6Y_Amp_s6p9[i][j]  +  CogTrqCalComp_T_Cnt_str[0].CoggingMY_Amp_s6p9;
			TrqCanc_MtrCurrQaxRpl12X_Amp_M_s6p9[i][j] =  t2_MtrCurrQaxRpl12X_Amp_s6p9[i][j] + CogTrqCalComp_T_Cnt_str[1].CoggingMX_Amp_s6p9;
			TrqCanc_MtrCurrQaxRpl12Y_Amp_M_s6p9[i][j] =  t2_MtrCurrQaxRpl12Y_Amp_s6p9[i][j] + CogTrqCalComp_T_Cnt_str[1].CoggingMY_Amp_s6p9;
			TrqCanc_MtrCurrQaxRpl18X_Amp_M_s6p9[i][j] =  t2_MtrCurrQaxRpl18X_Amp_s6p9[i][j] + CogTrqCalComp_T_Cnt_str[2].CoggingMX_Amp_s6p9;
			TrqCanc_MtrCurrQaxRpl18Y_Amp_M_s6p9[i][j] =  t2_MtrCurrQaxRpl18Y_Amp_s6p9[i][j] + CogTrqCalComp_T_Cnt_str[2].CoggingMY_Amp_s6p9;
		}
	}
...
STATIC FUNC(float32, AUTOMATIC) SinLookup( VAR(float32, AUTOMATIC) Theta_Rad_T_f32 )
{
	...
	Theta_Cnt_T_u16 = (uint16)(Theta_Rev_T_f32 * 2048.0f);
...
FUNC(void, TrqCanc_CODE) TrqCogCancRefPer1(void)
{
		...
		VAR(float32, AUTOMATIC) MtrCurrQax18Mag_Amp_T_f32;
		VAR(float32, AUTOMATIC) EstKe_VpRadpS_T_f32;
		VAR(float32, AUTOMATIC) CorrMtrPosElec_Rev_T_f32;
		VAR(float32, AUTOMATIC) MtrCurrQaxRpl_Amp_T_f32;
		...
		VAR(float32,AUTOMATIC) 	MtrCurrQax12Ph_Rad_T_f32;
		VAR(float32,AUTOMATIC) 	MtrCurrQax6Ph_Rad_T_f32;
		VAR(float32,AUTOMATIC) 	MtrCurrQax18Ph_Rad_T_f32;
		...
		MtrCurrQax6Mag_Amp_T_f32 =MtrCurrQax6Mag_Amp_M_f32[DataAccessBfr_Cnt_T_u16] ;
		MtrCurrQax12Mag_Amp_T_f32=MtrCurrQax12Mag_Amp_M_f32[DataAccessBfr_Cnt_T_u16] ;
	    MtrCurrQax6Ph_Rad_T_f32  =MtrCurrQax6Ph_Rad_M_f32[DataAccessBfr_Cnt_T_u16] ;
		MtrCurrQax12Ph_Rad_T_f32 =MtrCurrQax12Ph_Rad_M_f32[DataAccessBfr_Cnt_T_u16] ;
		MtrCurrQax18Mag_Amp_T_f32=MtrCurrQax18Mag_Amp_M_f32[DataAccessBfr_Cnt_T_u16] ;
	    MtrCurrQax18Ph_Rad_T_f32  =MtrCurrQax18Ph_Rad_M_f32[DataAccessBfr_Cnt_T_u16] ;

		/***Cogging torque***/
		if (MtrPosComputDelay_Rad_T_f32 < D_ZERO_ULS_F32)
		{
				MtrPosComputDelay_Rev_T_u0p16 = (uint16)((MtrPosComputDelay_Rad_T_f32 * D_SCALERADTOCNTS_ULS_F32) + D_REVWITHROUND_ULS_F32);
		}
		else
		{
				MtrPosComputDelay_Rev_T_u0p16 = (uint16)((MtrPosComputDelay_Rad_T_f32 * D_SCALERADTOCNTS_ULS_F32) + D_ONEHALF_ULS_F32);
		}
		...
		if(MtrElecPol_Cnt_T_s8 == D_ONE_CNT_S8)
			...
			CogginTrqCancIndex_T_Cnt_u16=FPM_FloatToFixed_m(((CorrMtrPosElec_Rad_T_f32)*D_COGGINGTBLRES_F32),u16p0_T);
			...
			CogginIqRef_Amp_T_f32=(CoggingTrqCanc_MtrNm_T_f32/(D_SQRT3OVR2_ULS_F32*EstKe_VpRadpS_T_f32));
			
			/***** Torue Ripple Compensation Effect *****/

			MtrPos6thHarAngle_Rad_T_f32=MtrCurrQax6Ph_Rad_T_f32 + (k_Harmonic6thElec_Uls_f32*CorrMtrPosElec_Rad_T_f32) ;
			MtrPos12thHarAngle_Rad_T_f32=MtrCurrQax12Ph_Rad_T_f32 + (k_Harmonic12thElec_Uls_f32*CorrMtrPosElec_Rad_T_f32);
			MtrPos18thHarAngle_Rad_T_f32 = MtrCurrQax18Ph_Rad_T_f32 + (k_Harmonic18thElec_Uls_f32*CorrMtrPosElec_Rad_T_f32);
				
		
		    MtrCurrQaxRpl_Amp_T_f32=((MtrCurrQax6Mag_Amp_T_f32*SinLookup(MtrPos6thHarAngle_Rad_T_f32))+(MtrCurrQax12Mag_Amp_T_f32*SinLookup(MtrPos12thHarAngle_Rad_T_f32))+(MtrCurrQax18Mag_Amp_T_f32*SinLookup(MtrPos18thHarAngle_Rad_T_f32)));

				
			/* Updating glbal variable buffers*/
			MtrCurrQaxRpl_Amp_M_f32[SlowDataAccessBufIndex_Cnt_M_u16]= MtrCurrQaxRpl_Amp_T_f32;
